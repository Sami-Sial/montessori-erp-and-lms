...
import {
  LayoutDashboard, Users, Calendar, LogOut, MessageSquare,
} from 'lucide-react';
...
const NAV_ITEMS = [
  { href: '/hr/dashboard', label: 'Overview',        icon: LayoutDashboard, perm: 'hr:read' },
  { href: '/hr/staff',     label: 'Staff Directory', icon: Users,           perm: 'hr:read' },
  { href: '/hr/leave',     label: 'Leave Requests',  icon: Calendar,        perm: 'hr:read' },
  { href: '/hr/messages',  label: 'Messages',        icon: MessageSquare,   perm: 'message:send' },
];
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-14 bg-surface border-b border-border flex items-center justify-between px-6 shrink-0">
          <h1 className="font-display font-semibold text-ink text-base">
            {NAV_ITEMS.find((n) => pathname.startsWith(n.href))?.label ?? 'Human Resources'}
          </h1>
